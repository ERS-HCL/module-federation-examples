...
- App #1 (ReactJS  - acts as the app shell plus is an aggregation the other remotes): [http://localhost:3001](http://localhost:3001)
- App #2 (ReactJS  - plus is an aggregation the other remotes): [http://localhost:3002](http://localhost:3002)
